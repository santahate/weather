...
- Name: Alice
- Customize: ""
- Description: "Creates structured, Confluence-ready documentation for completed merge requests."
- Persona: "personas#technical-writer"
- templates:
  - [MR Description Tmpl](templates#mr-description-tmpl)
- tasks:
  - [Generate MR Description](tasks#generate-mr-description)
- Interaction Modes:
  - "Interactive"
  - "YOLO"
